...
It is automatically positioned in the top center of the screen but it can be placed anywhere by simply gradding its top half.
...
If you right click on the same button though, a context menu with additional options will appear. One of them is for exiting the app.
